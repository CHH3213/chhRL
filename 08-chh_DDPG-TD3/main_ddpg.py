...
def train(args, env, agent):
    ...
    for i_ep in range(args.episodes):
        ...
        while True:
            ...
            writer.add_scalar("Loss/critic_loss", critic_loss, global_step=i_ep)
            state = next_state
...
def main(args):
    ...
    agent = DDPG(state_dim=s_dim, action_dim=a_dim, max_action=max_action, args=args)
