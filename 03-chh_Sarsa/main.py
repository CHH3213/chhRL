...
def parseSetting():
    ...
    parser.add_argument('--saveData_dir',
                        default="./save/sarsa/data/",
                        help="directory to store all experiment data")
    parser.add_argument('--saveModel_dir',
                        default='./save/sarsa/models/',
                        help="where to store/load network weights")
    parser.add_argument('--load_dir', default='./save/sarsa/models/',
...
def main(args):
    ...
    agent = Sarsa(state_dim, action_dim, args.lr, args.gamma, args.epsilon)
    if args.train:
