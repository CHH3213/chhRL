...
@Time: 2022/2/26 10:15
@PROJECT_NAME: chhRL
@File: main_offPolicy.py
@Author: chh3213
@Email:
@Description:
"""
from MC_OffPolicy import MonteCarlo
import gym
import argparse
import os
import numpy as np
...
def parseSetting():
    ...
    parser.add_argument('--env_name', default="CliffWalking-v0",
                        help="discrete environment name:FrozenLake-v0,CliffWalking-v0")
    ...
    parser.add_argument('--saveData_dir',
                        default="./save/mc_offPolicy/data/",
                        help="directory to store all experiment data")
    parser.add_argument('--saveModel_dir',
                        default='./save/mc_offPolicy/models/',
                        help="where to store/load network weights")
    parser.add_argument('--load_dir', default='./save/mc_offPolicy/models/',
...
def main(args):
    ...
    agent = MonteCarlo(state_dim, action_dim, args.gamma)
    if args.train:
