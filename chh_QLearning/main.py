...
def parseSetting():
    ...
    parser.add_argument('--epsilon', default=0.1, type=float, help="e-greedy factor")
    ...
    parser.add_argument('--saveData_dir',
                        default="./save/qlearning/data/",
                        help="directory to store all experiment data")
    parser.add_argument('--saveModel_dir',
                        default='./save/qlearning/models/',
                        help="where to store/load network weights")
    parser.add_argument('--load_dir', default='./save/qlearning/models/',
...
def main(args):
    ...
    agent = Qlearning(state_dim, action_dim, args.lr, args.gamma, args.epsilon)
    if args.train:
