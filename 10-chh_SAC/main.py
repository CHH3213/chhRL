...
def parseSetting():
    ...
    parser.add_argument('--algo', default="sac",
                        help="algo choice：sac")
    # 学习参数设置
    parser.add_argument('--lr_actor', default=0.0001, type=float, help="learning rate of actor network")
    parser.add_argument('--lr_q', default=0.001, type=float, help="learning rate of q network")
    parser.add_argument('--lr_v', default=0.001, type=float, help="learning rate of v network")
...
def main(args):
    ...
    from sac import SAC
    agent = SAC(state_dim=s_dim, action_dim=a_dim, args=args)
